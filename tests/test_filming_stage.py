...
def test_rgb_to_film_raw_passes_linear_sensitivity_to_hanatos2025(monkeypatch) -> None:
    ...
    to the generic `rgb_to_raw` dispatch. With color_filter='none' the sensitivity
    is passed through unmodified. Hanatos2025 adaptation is handled separately via
