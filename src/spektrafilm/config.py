...
def set_spectral_shape(start: float = 380, end: float = 780, step: float = 5) -> colour.SpectralShape:
    ...
    STANDARD_OBSERVER_LMS = _lms(SPECTRAL_SHAPE)
    from spektrafilm.model import illuminants as _il   # binds SPECTRAL_SHAPE at its import — re-point it here
