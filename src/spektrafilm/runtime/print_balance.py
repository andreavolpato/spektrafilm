...
def solve_neutral_filter_shifts(
    params, midgray: float = 0.184, max_nfev: int = 40
) -> tuple[float, float]:
    ...
    p.io.output_gamut_compress = OutputGamutCompressSpec(
        algorithm="off", lightness_compression=None
    )
